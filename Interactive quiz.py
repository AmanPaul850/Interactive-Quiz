...
if pw == "canisleepwithyou":
    pw = pyautogui.confirm(text="can i sleep with you", title="Question 1", buttons=["yes babe", "no you  idiot get outta my face"])
    if pw == "yes babe":
    ...
    if pw == "no":
        ...
        if pw == "1.5":
            ...
            if pw == 'show me how do i proof austin that i completed the test':
                ...
                pyautogui.confirm(text="ayo austin i, "+ naem + " completed the test that u cant complete LMFAO", title="austin u dump", buttons=["YOU DUMP AUSTIN"])
        else:
